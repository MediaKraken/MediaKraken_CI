...
STAGE_COMPOSE_IMAGES = {
    ...
    'ComposeMediaKrakenBroadcast': ('mkbroadcast', 'mkbase3122py3', 'alpine'),
    #'ComposeMediaKrakenConsul': ('mkconsul', 'alpine:3.9', 'alpine'),
    'ComposeMediaKrakenCron': ('mkcron', 'mkbase3122py3', 'alpine'),
    ...
    'ComposeMediaKrakenDownload': ('mkdownload', 'mkbase3122py3', 'alpine'),
    #'ComposeMediaKrakenFFProbe': ('mkffprobe', 'mkbaseffmpeg', 'alpine'),
    #'ComposeMediaKrakenHAProxy': ('mkpghaproxy', 'alpine:3.10', 'alpine'),
    'ComposeMediaKrakenHardware': ('mkhardware', 'mkbase3122py3', 'alpine'),
    'ComposeMediaKrakenLDAP': ('mkldap', 'lsiobase/alpine:3.11', 'alpine'),
    'ComposeMediaKrakenMetadata': ('mkmetadata', 'mkbase3122py3', 'alpine'),
    ...
    'ComposeMediaKrakenPika': ('mkpika', 'mkbase3122py3', 'alpine'),
    'ComposeMediaKrakenRabbitMQ': ('mkrabbitmq', 'alpine:3.11', 'alpine'),
    'ComposeMediaKrakenReactor': ('mkreactor', 'mkbase3122py3', 'alpine'),
    'ComposeMediaKrakenServer': ('mkserver', 'mkbase3122py3', 'alpine'),
    ...
    'ComposeMediaKrakenWebSanic': ('mkwebappsanic', 'mkbase3122py3', 'alpine'),
}
